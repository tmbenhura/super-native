<native:scroll-view class="w-full bg-theme-background">
    <native:column class="w-full p-5 gap-5">
        ...
        <native:column class="gap-1">
            ...
            <native:text class="text-[25] text-theme-on-background">Value 1: {{ number_format($slideValue, 3) }}</native:text>
            <native:text class="text-[25] text-theme-on-background">Value 2: {{ number_format($slideValue * 2, 3) }}</native:text>
        </native:column>
        ...
        <native:column class="gap-1">
            ...
            <native:text class="text-[25] text-theme-on-background">Value: {{ number_format($slideDebounced, 1) }}</native:text>
        </native:column>
        ...
        <native:column class="gap-1">
            ...
            <native:text class="text-[25] text-theme-on-background">Value: {{ number_format($slideBlur, 1) }}</native:text>
        </native:column>
