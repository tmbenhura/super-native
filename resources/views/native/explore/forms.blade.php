...
{{--        <text class="text-lg font-semibold mt-4 text-theme-on-background">Text Input — Filled</text>--}}
...
{{--            <text class="text-sm text-theme-on-surface-variant">Debounced (150ms)</text>--}}
{{--            <slider native:model.debounce.150ms="slideDebounced" :min="0" :max="100" class="w-full"/>--}}
{{--            <text class="text-[20] text-theme-on-background">Value: {{ number_format($slideDebounced, 1) }}</text>--}}
{{--        </column>--}}

{{--        <column class="gap-1">--}}
{{--            <text class="text-sm text-theme-on-surface-variant">On release (blur)</text>--}}
{{--            <slider native:model.blur="slideBlur" :min="0" :max="100" class="w-full"/>--}}
{{--            <text class="text-[20] text-theme-on-background">Value: {{ number_format($slideBlur, 1) }}</text>--}}
{{--        </column>--}}
...
{{--        --}}{{-- CHECKBOX --}}
{{--        <text class="text-lg font-semibold text-theme-on-background">Checkbox (composed)</text>--}}
{{--        @foreach ([--}}
...
{{--        --}}{{-- RADIO GROUP --}}
{{--        <text class="text-lg font-semibold text-theme-on-background">Radio Group (composed)</text>--}}
{{--        <column class="gap-2 w-full">--}}
{{--            <text class="text-sm text-theme-on-surface-variant">Pricing plan</text>--}}
